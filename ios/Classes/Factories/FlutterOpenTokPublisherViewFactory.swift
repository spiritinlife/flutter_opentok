...
class FlutterOpenTokPublisherViewFactory: NSObject, FlutterPlatformViewFactory {
    ...
    func create(withFrame frame: CGRect, viewIdentifier viewId: Int64, arguments args: Any?) -> FlutterPlatformView {
        ...
        controller.initPublisherView(frame: frame)
        
        return FlutterOpenTokPublisherView(controller: controller)
    }
}
